...
import { KpiStatusGrid, formatKpiValue as formatValue } from '@/components/kpi/KpiStatusGrid'
                ...
                <TabsContent value="charts" className="space-y-4">
                  ...
                  {kpisWithData.length > 0 && (
                    <div className="bg-panel border border-divider shadow-[0_1px_2px_rgba(0,0,0,0.05)] rounded-3xl p-5">
                      ...
                      <KpiStatusGrid
                        items={kpisWithData.map(({ kpi, unit, currentV, currentStatus, target, direction, pctOfTarget, deltaRaw }) => ({
                          id: kpi.id, name: kpi.name, unit, currentV, currentStatus, target, direction, pctOfTarget, deltaRaw,
                        }))}
